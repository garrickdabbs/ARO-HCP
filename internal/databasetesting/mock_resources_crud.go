...
// (the existing in-memory store for the regular containers) and MockKubeApplierClient
// (the in-memory store for the kube-applier container) without code duplication.
